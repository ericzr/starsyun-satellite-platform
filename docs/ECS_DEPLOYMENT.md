...
tar -czf starsyun-release.tgz dist dist-server package.json scripts src/app/data/country-iso2.json data/admin supabase/migrations deploy/systemd deploy/nginx
```
