...
- 2026-09-07 已在支付宝商家平台只读确认：企业账号的“电脑网站支付”为“已开通”。StarSyun 应用已创建，当前处于审核中；应用密钥、支付宝公钥和回调地址已准备，网关使用 `https://openapi.alipay.com/gateway.do` 。
...
1. 等待 StarSyun 应用审核通过，确认 AppID、回调、网关和证书信息与现有业务分离。
